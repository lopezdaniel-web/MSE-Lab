...
/* -----------------------------------------------------------------------
 * Vector table — single definition, placed at start of Flash
 * --------------------------------------------------------------------- */
uint32_t vector_tbl[] __attribute__((section(".isr_vector_tbl"))) = {
    (uint32_t)&_estack,                        /* Initial stack pointer (MSP)                  */
    (uint32_t)&Reset_Handler,                  /* Reset                                        */
    (uint32_t)&NMI_Handler,                    /* NMI / Clock Security System                  */
    ...
    0,                                         /* Reserved                                     */
    0,                                         /* Reserved                                     */
    (uint32_t)&SVC_Handler,                    /* System Service call via SWI                  */
    ...
    (uint32_t)&TAMP_STAMP_IRQHandler,          /* Tamper and TimeStamp through EXTI            */
    (uint32_t)&RTC_WKUP_IRQHandler,            /* RTC Wakeup through EXTI                      */
    ...
    (uint32_t)&TIM1_BRK_TIM9_IRQHandler,       /* TIM1 Break + TIM9 global                     */
    (uint32_t)&TIM1_UP_TIM10_IRQHandler,       /* TIM1 Update + TIM10 global                   */
    (uint32_t)&TIM1_TRG_COM_TIM11_IRQHandler,  /* TIM1 Trigger/Commutation + TIM11 global      */
    (uint32_t)&TIM1_CC_IRQHandler,             /* TIM1 Capture Compare                         */
    (uint32_t)&TIM2_IRQHandler,                /* TIM2 global                                  */
    (uint32_t)&TIM3_IRQHandler,                /* TIM3 global                                  */
    (uint32_t)&TIM4_IRQHandler,                /* TIM4 global                                  */
    ...
    (uint32_t)&SPI1_IRQHandler,                /* SPI1 global                                  */
    (uint32_t)&SPI2_IRQHandler,                /* SPI2 global                                  */
    (uint32_t)&USART1_IRQHandler,              /* USART1 global                                */
    (uint32_t)&USART2_IRQHandler,              /* USART2 global                                */
    0,                                         /* Reserved                                     */
    (uint32_t)&EXTI15_10_IRQHandler,           /* EXTI Line[15:10]                             */
    (uint32_t)&RTC_Alarm_IRQHandler,           /* RTC Alarms (A and B) through EXTI            */
    (uint32_t)&OTG_FS_WKUP_IRQHandler,         /* USB OTG FS Wakeup through EXTI               */
    0,                                         /* Reserved                                     */
    0,                                         /* Reserved                                     */
    0,                                         /* Reserved                                     */
    0,                                         /* Reserved                                     */
    (uint32_t)&DMA1_Stream7_IRQHandler,        /* DMA1 Stream7 global                          */
    0,                                         /* Reserved                                     */
    (uint32_t)&SDIO_IRQHandler,                /* SDIO global                                  */
    (uint32_t)&TIM5_IRQHandler,                /* TIM5 global                                  */
    (uint32_t)&SPI3_IRQHandler,                /* SPI3 global                                  */
    0,                                         /* Reserved                                     */
    0,                                         /* Reserved                                     */
    0,                                         /* Reserved                                     */
    0,                                         /* Reserved                                     */
    (uint32_t)&DMA2_Stream0_IRQHandler,        /* DMA2 Stream0 global                          */
    (uint32_t)&DMA2_Stream1_IRQHandler,        /* DMA2 Stream1 global                          */
    (uint32_t)&DMA2_Stream2_IRQHandler,        /* DMA2 Stream2 global                          */
    (uint32_t)&DMA2_Stream3_IRQHandler,        /* DMA2 Stream3 global                          */
    (uint32_t)&DMA2_Stream4_IRQHandler,        /* DMA2 Stream4 global                          */
    0,                                         /* Reserved                                     */
    0,                                         /* Reserved                                     */
    0,                                         /* Reserved                                     */
    0,                                         /* Reserved                                     */
    0,                                         /* Reserved                                     */
    0,                                         /* Reserved                                     */
    (uint32_t)&OTG_FS_IRQHandler,              /* USB OTG FS global                            */
    (uint32_t)&DMA2_Stream5_IRQHandler,        /* DMA2 Stream5 global                          */
    (uint32_t)&DMA2_Stream6_IRQHandler,        /* DMA2 Stream6 global                          */
    (uint32_t)&DMA2_Stream7_IRQHandler,        /* DMA2 Stream7 global                          */
    (uint32_t)&USART6_IRQHandler,              /* USART6 global                                */
    ...
    0,                                         /* Reserved                                     */
    0,                                         /* Reserved                                     */
    (uint32_t)&SPI4_IRQHandler,                /* SPI4 global                                  */
    (uint32_t)&SPI5_IRQHandler                 /* SPI5 global                                  */
};
...
void Reset_Handler(void)
{
    ...
    /* Convert byte sizes to 32-bit word counts (sizeof(uint32_t) == 4) */
    data_mem_size /= 4;
    bss_mem_size  /= 4;

    /* Initialize pointers to source (Flash LMA) and destination (SRAM VMA) */
    ...
    {
        *p_dest_mem++ = *p_src_mem++;   /* FIX: both pointers must advance each iteration */
    }
